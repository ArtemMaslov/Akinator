...
Узел дерева оборачивается в фигурные скобки `{}`. Сначала идёт значение узла (либо название объекта, либо его свойство). 
...
В узле-свойстве сначала идёт потомок, который обладает свойством узла, а потом потомок, который не обладает.
